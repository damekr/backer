...
func (b *BackupJob) Start() error{
	...
	log.Info("BackupConfig has been triggered properly!")
	return nil
}
...
func IntegrateClient(client *config.ClientConfig) error {
...
//func StartBackup(backupConfig *config.BackupConfig, clntAddr string) error {
...
func GetAllIntegratedClients() []config.ClientConfig {
